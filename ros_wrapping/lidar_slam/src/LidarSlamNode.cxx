...
void LidarSlamNode::SetSlamParameters()
{
  ...
  SetSlamParam(double, "slam/ego_motion_registration/max_distance_for_ICP_matching", EgoMotionMaxDistanceForICPMatching)
  ...
  SetSlamParam(double, "slam/localization/max_distance_for_ICP_matching", LocalizationMaxDistanceForICPMatching)
